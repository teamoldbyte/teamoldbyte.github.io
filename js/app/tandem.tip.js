...
(function($, document, tandem) {
	...
	const tandemRules = [
		...
		`${rul_div}동사 서술어</b><br>(predicate for verb)${and_exampl}I'm <span class=\"sem v inner cmnt-align-center example\" data-rc=\"V(p)\" data-rc-min=\"V(p)\">sure</span> that he's kind.</div><div class=\"col-4 my-auto\">동사 + 형용사의 결합이<br>의미적 충분성이 부족한 서술어인 경우</div></div>`,
