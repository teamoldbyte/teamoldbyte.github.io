			...
			await $.get('https://static.findsvoc.com/fragment/tandem/editor_template.min.html', (result) => {
				...
				.on('mouseup', '.edit-svoc[data-mode="cleft"]', function(e) {
					...
					if(!sel.isCollapsed){
						...
						.match(/^[iI]t( is| was|'s| had been| has been|'s been|'ll be|'ll have been| will be| will have been| can be| could be| could have been| would be| would have been| may be| may have been| might be| might have been)[ ,].+\S$/);
						if(selMatch) {
