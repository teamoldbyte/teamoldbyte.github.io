...
function pageinit(sentenceList, memberId, isSsam) {
	...
	}else if(sessionStorage.getItem('workbookId')) {
		workbookId56 = ntoa(sessionStorage.getItem('workbookId'));
	}
...
// --------------------------- 사용량 측정 Start --------------------------------
	...
	function _verifyUsageLimit(callback) {
		if(!isSsam && memberId != 15000550 && memberId != 15000590 && memberId != 15001021 && memberId != 15001905 && memberId != 15001515 && memberId != 15002176 && memberId != 15002185 && memberId != 15002196 && myFicoUsages.length >= MAX_SENTENCE_LENGTH_PER_DAY) {
