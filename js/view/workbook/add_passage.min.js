function pageinit(r,e,a){$(window).on("unload",()=>$("#loadingModal").modal("hide"));let x={itemSelector:".passage",columnWidth:".passage",gutter:10,percentPosition:!0,transitionDuration:"0.8s"},t=5e3.toLocaleString();var n=(new Date).format("yyyy-MM-dd");let d="MFUSG";var s=localStorage.getItem(d);let c=s?JSON.parse(atob(s)):{};function i(){!a&&15000550!=e&&15000590!=e&&15000998!=e&&15001122!=e&&15001021!=e&&15001905!=e&&15001515!=e&&15002176!=e&&15002181!=e&&15002185!=e&&15002196!=e&&15002227!=e&&5e3<=c.length&&($("#inputComplete, .ocr-btn").prop("disabled",!0),$("#newPassageText").prop("disabled",!0).addClass("form-control").attr("placeholder",`일일 분석량(${t}자)을 모두 소진했습니다. 내일 다시 찾아와 주세요.`),alertModal(`일일 분석량<span class="text-red-700">(${t}자)</span>을 모두 <span class="text-red-700">소진</span>했습니다.
