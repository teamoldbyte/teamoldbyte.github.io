...
function pageinit(battlePage) {
	...
	const totalPages = battlePage?.totalPages,
		currPage = battlePage?.number + 1,
		blockLength = 10, 
	...
	battleListContainer.appendChild(createElement(Array.from(battlePage.content, battle => {
	...
	battlePaginationContainer.appendChild(createElement(pageNavs));
