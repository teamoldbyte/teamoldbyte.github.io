...
: ${e.partType} `+e.meaning),$(".add-new-sense-label").before(createElement(a(l,e)))},error:()=>alertModal("단어 뜻을 추가하지 못 했습니다.")})}}).on("click",".js-add-cancel",function(){$(this).hide(),$(this).closest(".add-new-sense-section").find(".js-add-meaning").hide(),$(this).closest(".add-new-sense-section").find("input").val("")}).on("click",".js-del-meaning",function(){const e=$(this).closest(".one-part-unit-section");var t={wordId:e.closest(".showup-word").data("wordId"),showUpId:e.data("sid")};$.ajax({url:"/adminxyz/dictionary/showupsense/del",type:"POST",data:t,success:()=>{alertModal("뜻을 삭제했습니다."),e.remove()},error:()=>alertModal("단어 뜻을 삭제하지 못 했습니다.")})})}